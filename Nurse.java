...
interface INurse {
    ...
    ArrayList<String> getAssignedPatients();

    boolean assignPatient(String patientId);

    boolean unassignPatient(String patientId);

    void notifyDischargeInitiated(String patientId);

    void dischargeCompleted(String patientId);
}
